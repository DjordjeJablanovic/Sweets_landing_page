    ...
    return (
      <section className='lg:py-16 xl:pb-[160px] px-2'>
        <div className='container mx-auto'>
          ...
          >
              <div className='text-[200px] md:text-[360px] xl:text-[720px] lg:text-[500px] leading-none font-tertiary lg:-tracking-[0.055em] bg-aboutus bg-no-repeat bg-right bg-clip-text text-transparent'>
                77
              </div>
              </motion.div>
            {/* text */}
          ...
          >
              ...
              <div className='flex flex-col items-end'>
                <div className='max-w-[530px] text-grey flex flex-col px-3 items-center'>
